...
module CoSt = struct
  ...
  (* TODO add the initial value for two booleans *)
...
(* Set the values of write events *)
  ...
  let exist_plain_value_write ns =
      List.exists 
      ( fun n -> match n.evt.bank with
      |Ord|Tag|CapaTag|CapaSeal|VecReg _|Pair|Instr ->
          begin
        ...
        | Some W ->
            let st =
              ...
              |Ord|Pair|VecReg _| Instr ->
                (* TODO what is the is_data check here? *)
...
(* Set locations *)
  (* TODO how does the starting point decide? *)
  let sd,n =
    let no =
