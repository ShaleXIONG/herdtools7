...
let parse_sub_command () =
   ...
   | "version" -> diy_spec (),ref 1
   | "show" -> show_specs (),ref 1
   | "single-test" -> diy_spec (),ref 1
   | "multi-tests" -> diy_spec (),ref 1
   | "test-generation-filter-check" -> diy_spec (),ref 1
   | "test-generation" -> diy_spec (),ref 1
